...
class Application(db.Model):
    ...
    register_no = db.Column(db.String(20), db.ForeignKey('user.register_no'), nullable = False)
    drive_id = db.Column(db.Integer, db.ForeignLey('placement_drive.drive_id'), nullable = False)
    applied_date = db.Column(db.DateTime, default = datetime.now(datetime.timezone.utc), nullable = False)
